package com.github.vuzoll.datasets.config
...
@Configuration
@EnableMongoRepositories('com.github.vuzoll.datasets.repository')
class MongoConfiguration extends AbstractMongoConfiguration {
    ...
    static String USERNAME = System.getenv('MONGO_USERNAME') ?: 'vuzollDatasetsService'
    ...
    protected String getMappingBasePackage() {
        'com.github.vuzoll.datasets.domain'
    }
}